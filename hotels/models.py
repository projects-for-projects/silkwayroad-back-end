...
class Hotel(models.Model):
    ...
    food_categories = models.ManyToManyField(FoodCategory, related_name='hotels', default=None)
    hotel_category = models.ManyToManyField(HotelCategoryStars, related_name='hotels', default=None)
    additional_services = models.ManyToManyField(AdditionalService, related_name='hotels', default=None)
    child_services = models.ManyToManyField(ChildService, related_name='hotels', default=None)
...
class Room(models.Model):
    ...
    hotel = models.ForeignKey(Hotel, on_delete=models.CASCADE, related_name='rooms', default=None)
    ...
    facilities_and_services = models.ManyToManyField(FacilitiesAndServicesRooms, related_name='rooms', default=None)
...
class PeriodPrice(models.Model):
    room = models.ForeignKey(Room, on_delete=models.CASCADE, related_name='prices', default=None)
    currency = models.CharField(max_length=10)
...
class FacilitiesAndServicesHotels(models.Model):
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='facilities_and_services', default=None)
    hotel_category_name = models.CharField(max_length=255)
    hotel_category_name_en = models.CharField(max_length=255, blank=True, null=True)
    hotel_category_name_ru = models.CharField(max_length=255, blank=True, null=True)
    hotel = models.ManyToManyField(Hotel, related_name='facilities', default=None)
...
class Booking(models.Model):
    guest = models.ForeignKey(UserAccount, on_delete=models.CASCADE, related_name='bookings', default=None)
    hotel = models.ForeignKey(Hotel, on_delete=models.CASCADE, related_name='bookings', default=None)
    checkin_date = models.DateField()
    checkout_date = models.DateField()
