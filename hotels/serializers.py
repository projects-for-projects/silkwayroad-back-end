...
from hotels.models import (
    Room, Category, Booking, RoomCharacteristics, PeriodPrice,
    FacilitiesAndServicesHotels, FacilitiesAndServicesRooms,
    Hotel, Characteristics, Country, City, HotelImage, FoodCategory,
